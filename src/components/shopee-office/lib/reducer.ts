...
import type { SeatDef as DiscoveredSeat } from "./events";
...
// Shopee specific sprite mapping
const WORKER_SPRITES = [
  { key: 'worker_male_1', label: 'Product Scout' },
  { key: 'worker_female_1', label: 'Link Builder' },
  { key: 'worker_male_2', label: 'Campaign Master' },
  { key: 'worker_female_2', label: 'Analytics Agent' },
  { key: 'worker_female_3', label: 'Content Writer' },
  { key: 'worker_male_3', label: 'Payout Checker' },
  { key: 'worker_male_4', label: 'SEO Optimizer' },
  { key: 'worker_female_4', label: 'Review Monitor' },
];
