...
// ── Persistence keys ─────────────────────────────────────
export const LS_CONFIG = "shopee-office:gateway-config";
export const LS_TASKS = "shopee-office:tasks";
export const LS_CHAT = "shopee-office:chat";
export const LS_SESSIONS = "shopee-office:sessions";
export const LS_ACTIVE_KEY = "shopee-office:active-session-key";
export const LS_SEAT_CONFIG = "shopee-office:seat-config";
export const LS_BGM_VOLUME = "shopee-office:bgm-volume";
export const LS_ONBOARDING_DONE = "shopee-office:onboarding-done";
